...
namespace snsrCollector.Migrations
{
    ...
    [Migration("20200413202600_InitialCreate")]
            ...
            modelBuilder.Entity("snsrCollector.dbTables.Network", b =>
                {
                    ...
                    b.Property<string>("LeftDeviceId")
                        .IsRequired()
                        .HasColumnName("Left_device_id")
                        .HasColumnType("character varying");

                    b.Property<string>("RightDeviceId")
                        .IsRequired()
                    ...
                    b.HasIndex("LeftDeviceId");

                    b.HasIndex("RightDeviceId");
...
");
            ...
            modelBuilder.Entity("snsrCollector.dbTables.ProfileNetwork", b =>
                {
                    ...
                    b.Property<string>("LeftProfileId")
                        .HasColumnName("Left_profile_id")
                        .HasColumnType("character varying");

                    b.Property<string>("RightProfileId")
                        .IsRequired()
                    ...
                    b.HasIndex("LeftProfileId");

                    b.HasIndex("RightProfileId");
            ...
            modelBuilder.Entity("snsrCollector.dbTables.Network", b =>
                {
                    b.HasOne("snsrCollector.dbTables.Device", "LeftDevice")
                        .WithMany("NetworkLeftDevice")
                        .HasForeignKey("LeftDeviceId")
                        .HasConstraintName("network_Left_device_id_fkey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("snsrCollector.dbTables.Device", "RightDevice")
                        .WithMany("NetworkRightDevice")
                        .HasForeignKey("RightDeviceId")
            ...
            modelBuilder.Entity("snsrCollector.dbTables.ProfileNetwork", b =>
                {
                    b.HasOne("snsrCollector.dbTables.DeviceProfile", "LeftProfile")
                        .WithMany("ProfileNetworkLeftProfile")
                        .HasForeignKey("LeftProfileId")
                        .HasConstraintName("left_profile")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("snsrCollector.dbTables.DeviceProfile", "RightProfile")
                        .WithMany("ProfileNetworkRightProfile")
                        .HasForeignKey("RightProfileId")
